  ...
  return (
    <ManagerLayout>
      <div className="p-6 max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 tracking-tight text-gray-900">Analytics Overview</h1>

        {/* KPIs */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-10">
          {[
            { label: "Revenue (last 30 days)", value: "42,500 CHF" },
            { label: "Tickets Sold", value: "6,743" },
            { label: "Conversion Rate", value: "7.2%" },
            { label: "Top Event", value: "Techno Night" },
          ].map((stat) => (
            <div key={stat.label} className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-10">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={fakeRevenueData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
