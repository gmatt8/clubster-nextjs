...
export default function ManagerSettingsPage() {
  return (
    <ManagerLayout>
      ...
      >
        {/* Box: General */}
        <Link href="/manager/settings/general" style={{ textDecoration: 'none' }}>
          <div
            style={{
              width: '280px',
              height: '160px',
        ...
        <Link href="/manager/settings/login-and-security" style={{ textDecoration: 'none' }}>
          <div
            style={{
              width: '280px',
              height: '160px',
        ...
        {/* Box: Legal */}
        <Link href="/manager/settings/legal" style={{ textDecoration: 'none' }}>
          <div
            style={{
              width: '280px',
              height: '160px',
