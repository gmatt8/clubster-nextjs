    ...
    <ManagerLayout>
      ...
      <div className="px-6 py-8 max-w-screen-xl mx-auto text-left">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link href="/dashboard/manager/settings/legal/privacy-policy" className="no-underline w-full sm:w-auto">
          ...
          <Link href="/dashboard/manager/settings/legal/terms-of-service" className="no-underline w-full sm:w-auto">
            <button className="w-full sm:w-auto bg-purple-600 text-white font-semibold py-2 px-4 rounded hover:bg-purple-700 transition">
              Terms of Service
            </button>
          </Link>
